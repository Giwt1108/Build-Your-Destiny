...
public class MainGame extends Game {
    ...
    private TextButton buttonAtack;
    Jugador jugador;
    Enemigo enemigo;
    ...
    public void create () {
        ...
        //Gdx.input.setInputProcessor(this.jugador);
        this.jugador.setVelocidadX(0); //le damos una velocidad inicial arbitraria
        ...
        jugador.setHabilidad(habilidadCien);
    ...
    public void mostrarBoton(TextButton button){
        this.buttonAtack = button;
        this.stage.addActor(this.buttonAtack);
    }
    ...
    public void perfoAtaqueDis(boolean pressedScreen, float delta){
        ...
        if(Gdx.input.isKeyJustPressed(Input.Keys.Q)){
            ...
            boolean pressedButton = this.buttonAtack.isPressed();
            ...
            this.buttonAtack.setVisible(buttonActive);
            if(newButton != null){
